...
<img width="1832" height="896" alt="Image" src="https://github.com/user-attachments/assets/f52b50f5-22dd-4fcc-b8a8-1651927dcc13" />
### ✅ 구독 조합 기능
- 사용자가 선택한 구독 서비스 3개로 조합 상품 생성
- 조합 상품 결제 시 자동 할인 적용

<img width="884" height="896" alt="Image" src="https://github.com/user-attachments/assets/082ad324-3358-4145-ac2a-883bcda7b72f" />
### ✅ 소비 데이터 기반 추천
- 카드 소비내역 분석 후 구독 서비스, 카드 추천
- 카테고리별 지출 금액, 구매 빈도를 기반으로 개인화된 제안

<img width="1838" height="922" alt="Image" src="https://github.com/user-attachments/assets/55b08f84-4614-4fcd-84a1-c91d02b7d7b9" />
### ✅ 사용자 맞춤형 대시보드
...
<img width="1340" height="860" alt="Image" src="https://github.com/user-attachments/assets/20e3d66c-6413-437e-b0f1-5ff0f522d7cf" />
